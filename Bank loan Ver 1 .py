...
HLoan=[5000000,7000000,9000000] #Category levels
PLoan=[2000000,4000000,6000000] #Category Levels
CLoan=[1000000,2000000,3000000] #Category Levels
Hloanrange=(125000,350000,675000)  #Criteria Calculation
CLoanrange=(25000,100000,225000)   #Criteria Calculation
PLoanrange=(50000,200000,450000)   #Criteria Calculation
i=1   #Program Variable
print("Welcome to the Bank Loan Application\nKindly give the folowing details")
...
else:print("You didn't selected  any category")